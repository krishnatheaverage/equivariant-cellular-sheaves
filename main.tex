...
\pgfplotsset{
  ggplot/.style={
    grid=major,
    major grid style={gray!25,line width=0.4pt},
    tick align=outside,
    tick style={gray!50},
    ...
    legend style={draw=gray!50,fill=white,font=\footnotesize},
  },
}
...
\title[Equivariant Cellular Sheaves for Molecular Electronic Structure]{Equivariant Cellular Sheaves for Molecular Electronic Structure: Bridging Sheaf Cohomology and $E(3)$-Equivariant Hamiltonian Learning}

\author*[1]{\fnm{Krishna} \sur{Harish}}\email{krishnaharish2009@gmail.com}

\affil[1]{\orgname{Elkins High School}, \orgaddress{\city{Missouri City}, \state{TX}, \country{USA}}}
...
\keywords{cellular sheaves, sheaf cohomology, Hodge Laplacian, equivariant neural networks, electronic structure}

\pacs[MSC Classification]{55N30, 05C50, 68T07, 92E10}
...
\begin{axis}[
  ...
  ymin=0, ymax=2.4, ytick={0,1,2},
  ylabel={count},
  symbolic x coords={ethylene,allyl,butadiene,pentadienyl,hexatriene,benzene,cyclobutadiene,cyclooctatetraene,trimethylenemethane,naphthalene},
  xtick=data,
  xticklabel style={rotate=45,anchor=east,font=\scriptsize},
  enlarge x limits=0.05,
  legend style={at={(0.02,0.97)},anchor=north west},
]
\addplot[draw=black,fill=black!72] coordinates {(ethylene,0)(allyl,1)(butadiene,0)(pentadienyl,1)(hexatriene,0)(benzene,0)(cyclobutadiene,2)(cyclooctatetraene,2)(trimethylenemethane,2)(naphthalene,0)};
\addplot[draw=black,pattern=north east lines] coordinates {(ethylene,0)(allyl,1)(butadiene,0)(pentadienyl,1)(hexatriene,0)(benzene,0)(cyclobutadiene,0)(cyclooctatetraene,0)(trimethylenemethane,2)(naphthalene,0)};
\legend{$\dim H^0$ (non-bonding states), lower bound $\big||V_A|-|V_B|\big|$}
\end{axis}
\end{tikzpicture}
...
\begin{axis}[
  ...
  xmode=log,
  xtick={20,40,80,160}, xticklabels={20,40,80,160},
  xlabel={number of training molecules},
  ylabel={test MAE (gap, $|t|$ units)},
  ymin=0.08, ymax=0.40,
  legend style={at={(0.98,0.97)},anchor=north east},
]
\addplot[black,mark=*,mark size=1.8pt,line width=0.9pt,
  error bars/.cd,y dir=both,y explicit]
 coordinates {
  (20,0.31944) +- (0,0.07707)
  (40,0.20273) +- (0,0.01455)
  (80,0.13659) +- (0,0.02314)
  (160,0.11238) +- (0,0.00655)};
\addplot[black!55,dashed,mark=square,mark size=1.8pt,line width=0.9pt]
 coordinates {(20,0.23413)(40,0.21908)(80,0.23171)(160,0.22297)};
\addplot[black!55,dotted,mark=triangle,mark size=2.2pt,line width=0.9pt]
 coordinates {(20,0.24014)(40,0.26887)(80,0.30460)(160,0.26919)};
\legend{equivariant sheaf (canonical = rotated), coordinate MLP (canonical), coordinate MLP (rotated)}
\end{axis}
\end{tikzpicture}
...
the coordinate model plateaus and degrades on rotated test molecules. Error bars
on the equivariant curve show $\pm1$ s.d.\ over three seeds.}
\label{fig:e4}
\end{figure}
...
experiment, figure, and reported number is openly available at
\url{https://github.com/krishnatheaverage/equivariant-cellular-sheaves} and
archived on Zenodo (DOI:~\href{https://doi.org/10.5281/zenodo.20788374}{10.5281/zenodo.20788374}).
